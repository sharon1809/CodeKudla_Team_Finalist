...
import dailyMedService from './DailyMedService.js';
import drugInteractionService from './DrugInteractionService.js';
import aiService from './AIService.js';

class DrugService {
  async getOrCreateDrug(drugName) {
  ...
  async checkAllergies(patient, drug) {
   ...
   */
  async performSafetyCheck(patient, drugName) {
