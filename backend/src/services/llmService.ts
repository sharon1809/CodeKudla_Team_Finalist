...
import { IMessage, ICitation } from '../types';
import { QueryResultMatch } from './pineconeService';
 ...
 */
export const generateAnswerWithLLM = async (
  question: string,
  chatHistory: IMessage[],
  contextChunks: QueryResultMatch[]
